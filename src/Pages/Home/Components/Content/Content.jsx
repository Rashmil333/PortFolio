  ...
  return (
    <group ref={flowersRef} position={[0, 0, 0]}>
      <WhiteBloodCell
        ...
        hovered={hovered}
        position={[0, 0, 0]}
        texture={"/Textures/flower 1.png"}
      />
      <WhiteBloodCell
        index={2}
        hovered={hovered}
        position={[2, 0, -4]}
        texture={"/Textures/flower4.jfif"}
      />
      <WhiteBloodCell
        index={3}
        hovered={hovered}
      ...
      <WhiteBloodCell
        ...
        hovered={hovered}
        position={[-3, 2, -4]}
        texture={"/Textures/flower5.jpg"}
      />
      <WhiteBloodCell
        index={5}
        hovered={hovered}
        position={[-4, -2, -4]}
        texture={"/Textures/flower6.webp"}
      />
      <WhiteBloodCell
        index={6}
        hovered={hovered}
    ...
    <div className={styles.contentWrapper}>
      ...
      >
        {!hovered ? (
          ...
          <p className={styles.canvas_heading}>I {"BREAK"} THINGS</p>
        )}
      </div>
